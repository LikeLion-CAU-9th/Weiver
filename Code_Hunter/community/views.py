...
def community(request):
    ...
    paginator = Paginator(communities, 2)
    ...
    return render(request,'community.html', {'communities': communities, 'date_now':date_now, 'p_range' : paginate_range, 'start_page': start_page, 'end_page': end_page, 'current_page': page})
